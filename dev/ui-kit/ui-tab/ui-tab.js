const tab = function () {
    let tabNav = document.querySelectorAll('.js-tabs-nav'), // Выбираем элементы навигации табов
        tabContent = document.querySelectorAll('.js-tabs-content'), // Выбираем сами табы
